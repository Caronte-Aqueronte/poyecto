<%-- 
    Document   : mueble-mas-vendido
    Created on : 1/09/2021, 22:37:11
...
<html>
    <head>
        ...
        <title>Mueble mas vendido en intervalo de tiempo</title>
    </head>
    <body>
        <%
                ...
                <div class="col-sm">
                    <div style="float: left; width: 600px; height: 250px;  margin: 30px">
                        <form method="post" action="/MiMuebleria/Consultas">
                            ...
                            <button type="submit" class="btn btn-success mt-3 me-3" name="btnMuebleMasVendido">Consultar ventas</button>

                        </form>    
                        <button onclick="crearCsv('Mueble mas vendido en intervalo de tiempo <%=Reporte.obtenerFechaYHoraActual()%>.csv')" class="btn btn-success mt-3 me-3">Descargar tabla en CSV</button>
                    </div>

                    <table class="table table-striped">
                        <tr>                               
                            <th scope="col">Mueble mas vendido <%=fecha1%> al <%=fecha2%></th>
                        </tr>
                        <tr>                               
                            <th scope="col">Nombre dle mueble mas vendido</th>
